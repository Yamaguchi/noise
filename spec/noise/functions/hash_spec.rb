...
RSpec.describe Noise::Functions::Hash do
  describe '.hmac_hash' do
    ...
    context 'SHA512' do
      let(:digest) { 'SHA512' }
      let(:key) do
        '43a9c4a9eed5b5046a714e6c8d21636bcbba9b3ebf1e62f3669564851b147787' \
        '3bdf7e24553188c22614aa6057c98098aa3076110ef5df0000f57f5d958dd92f'.htb
      end
      let(:data) do
        'a87877e1914c742c739b7867c42614ce831476d07b5da17edd895fa7bd0c2054' \
        '9ddd1d3f8dcc808bfb41e72093c68ca99a67c1eca3e9a7422ab93b2ac7800f2302'.htb
      end
      let(:expected) do
  ...
  describe '.hkdf' do
    ...
    context 'SHA512 - num_outputs=2' do
      ...
      let(:expected) do
        [
          'bea9be3ec037c9fd921606725c266c727f29c9b076129d0dbc187938a63ac5c5' \
          'a7c3f091899c9e1b2e382d57ac4576216051cf4f33aba6b12189cd60a7b89afa',
          '03b1a6cc25009fe0da665be832ede23c4527e78edd63b34145001129ae9235cc' \
    ...
    context 'SHA512 - num_outputs=3' do
      let(:chaining_key) do
        ...
        '4e5fb14e829c7c88749b2c10c2cd845aeda7bc2abb53c8b776cb41bd2d1c2ea0'.htb
      end
      let(:input_key_material) { '54686973206973206d7920417573747269616e20706572737065637469766521'.htb }
      let(:num_outputs) { 3 }
      let(:digest) { 'SHA512' }
      let(:expected) do
        [
          'c2a5a1534869a81c007b0ab207dbe75ea3ab121c86259efa06c91c96518d67ed' \
          '132f26217de9acc2c5bf00e1f47a3baca40494ef68a3c6d88224b6b382af55a9',
          '30e3e5c1d79dad644a9873b003ef6d7358e3ac9c75e0d238a6a5cde636d5c37c' \
          '350a6f6a1bdc0c57edd95cbfdf26fc11f3d64b6133253f347765d8e9314c6c30',
          '6b32535f706a17f18d416c72d7bd9ca34bc0669ce3f0d465f98e2f93349f92d8' \
